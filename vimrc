...
map <leader>t2 :set shiftwidth=4<cr>
map <leader>t4 :set shiftwidth=4<cr>
au FileType html,python,scala,vim,javascript setl shiftwidth=4
au FileType html,python,scala,vim,javascript setl tabstop=4
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   "au FileType python so ~/.vim/bundle/python.vim/plugin/python_fn.vim
...
let Tlist_Ctags_Cmd='$HOME/local/ctags/bin/ctags'
